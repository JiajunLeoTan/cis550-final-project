...
- `npm test` - run client Vitest tests
...
└── src/
    ...
    │       └── LineChart.jsx
    ├── pages/
    │   ├── Home.jsx            # Search entry, proven picks, featured deals
    │   ├── Browse.jsx          # Search + category previews
    │   ├── Deals.jsx           # Deal listing and filters
    │   ├── CategoryPage.jsx    # Paginated category products
    │   ├── BrandPage.jsx       # Paginated brand products
...
Backend routes and client wrappers:
...
| `GET /deals` | Home, Deals |
| `GET /products/category` | Browse category previews, CategoryPage |
| `GET /products/brand` | BrandPage |
...
- Review-dependent analytics can still be empty for categories without linked
  monthly review coverage. All empty states explain this to the user.
- The Balanced value-ranking preset uses `0.4/0.2/0.2/0.2`, matching the
  indexed optimized score in the backend materialized view.
